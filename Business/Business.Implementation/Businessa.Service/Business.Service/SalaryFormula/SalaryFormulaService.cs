...
namespace Business.Interface.ISalaryFormula
{
    public class SalaryFormulaService : ISalaryFormula
    {
        ...
        public async Task<PagedDataTable<SalaryFormula>> GetAllSalaryFormula(int employeeCategoryId,int salaryFormulaTypeId, int pageNo = 1, int pageSize = 10, string searchString = "", string orderBy = "SrNo", string sortBy = "ASC")
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            try
            {
                SqlParameter[] param = {
                        ...
                        ,new SqlParameter("@SalaryFormulaTypeID",salaryFormulaTypeId)
                        ,new SqlParameter("@SortBy",sortBy=="ASC"?0:1)
                        };
        ...
        public async Task<int> AddUpdateSalaryFormula(SalaryFormula salaryFormula)
        {
            try
            {
                SqlParameter[] param = {
                    ...
                    ,new SqlParameter("@SalaryFormulaTypeID", salaryFormula.SalaryFormulaTypeID )
                };
