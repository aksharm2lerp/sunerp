...
namespace Business.Service
{
    public class MasterService : IMasterService
    {
        ...
        PagedDataTable<ProductCategoryMaster> IMasterService.GetAllItemCategory()
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            ...
            try
            {
                ...
                using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_ProductCategoryMaster", param))
                {
                    if (ds.Tables.Count > 0)
                    {
                        table = ds.Tables[0];
        ...
        public PagedDataTable<VanueTypeMaster> GetVanueTypeMasterAsync()
        {
            ...
            try
            {
...

                {
                    ...
                    //lst = table.ToPagedDataTableList<VanueTypeMaster>(1, 20, totalItemCount, null, "VenueTypeText", "ASC");
        ...
        #region Employee name by DepartmentID, Method Added by Rahul Mistry on 11-Apr-2023.

        public async Task<PagedDataTable<EmployeeMaster>> EmployeeNameByDepartmentID(int departmentId)
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            PagedDataTable<EmployeeMaster> lst = new PagedDataTable<EmployeeMaster>();
            try
            {
                ...
                DataSet ds = await SqlHelper.ExecuteDatasetAsync(connection, CommandType.StoredProcedure, "Usp_GetAll_EmployeeByDepartmentId", param);
                {
                    if (ds.Tables.Count > 0)
                    {
                        table = ds.Tables[0];
        ...
        #endregion Employee name by DepartmentID, Method Added by Rahul Mistry on 11-Apr-2023.
        ...
        public async Task<PagedDataTable<ParentMenuM>> GetMainMenu(int id)
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            try
            {
                ...
                using (DataSet ds = await SqlHelper.ExecuteDatasetAsync(connection, CommandType.StoredProcedure, "Usp_Get_GenerateMenuList", param))
                {
                    if (ds.Tables.Count > 0)
                    {
                        table = ds.Tables[1];
                    ...
                    PagedDataTable<ParentMenuM> lst = table.ToPagedDataTableList<ParentMenuM>
                        (1, 0, totalItemCount, "", "", "");
                    return lst;
                }
            }
        ...
        public async Task<PagedDataTable<MenuMasterM>> MainMenu(int id)
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            try
            {
                ...
                using (DataSet ds = await SqlHelper.ExecuteDatasetAsync(connection, CommandType.StoredProcedure, "Usp_Get_GenerateMenuList", param))
                {
                    ...
                    PagedDataTable<MenuMasterM> lst = table.ToPagedDataTableList<MenuMasterM>
                        (1, 0, totalItemCount, "", "", "");
                    return lst;
                }
            }
        ...
        #region Parent Menu & Menu List
        //Create By Dravesh Lokhande 30-06-2023
        public PagedDataTable<MenuMasterM> GetAllParentMenuListAsync()
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            PagedDataTable<MenuMasterM> lst = new PagedDataTable<MenuMasterM>();
            try
            {
                using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_ParentMenuMaster"))

                {
                    ...
                    lst = table.ToPagedDataTableList<MenuMasterM>
                       (1, 20, totalItemCount, null, "PackageName", "ASC");
        ...
        public PagedDataTable<MenuMasterM> GetAllMenuListAsync()
        {
            DataTable table = new DataTable();
            int totalItemCount = 0;
            PagedDataTable<MenuMasterM> lst = new PagedDataTable<MenuMasterM>();
            try
            {
                using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_MenuMaster"))
        ...
        #endregion Parent Menu & Menu List


        #endregion Menu master

        #region "Item Master"
        public async Task<PagedDataTable<ItemSubGroupMaster>> GetAllItemTypes()
        {
            try
            {
                DataTable table = new DataTable();
                int totalItemCount = 0;
                PagedDataTable<ItemSubGroupMaster> lst = new PagedDataTable<ItemSubGroupMaster>();
                try
                {
                    using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_ItemSubGroupMaster"))

                    {
                        ...
                        lst = table.ToPagedDataTableList<ItemSubGroupMaster>
                           (1, 20, totalItemCount, null, "ItemSubGroupText", "ASC");
                    }
                }
                catch
                {
        ...
        public async Task<PagedDataTable<ItemGroupMaster>> GetAllItemGroupTypes()
        {
            try
            {
                try
                {
                    DataTable table = new DataTable();
                    int totalItemCount = 0;
                    PagedDataTable<ItemGroupMaster> lst = new PagedDataTable<ItemGroupMaster>();
                    try
                    {
                        using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_SubGroup"))

                        {
                            ...
                            lst = table.ToPagedDataTableList<ItemGroupMaster>
                               (1, 20, totalItemCount, null, "ItemGroupName", "ASC");
                        }
                    }
                    catch
                    {
        ...
        public async Task<PagedDataTable<LocationMaster>> GetAllLocations()
        {
            try
            {
                DataTable table = new DataTable();
                int totalItemCount = 0;
                PagedDataTable<LocationMaster> lst = new PagedDataTable<LocationMaster>();
                try
                {
                    using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_LocationMaster"))

                    {
                        ...
                        lst = table.ToPagedDataTableList<LocationMaster>
                           (1, 20, totalItemCount, null, "LocationName", "ASC");
                    }
                }
                catch
                {
        ...
        public async Task<PagedDataTable<WareHouseMaster>> GetAllWarehouse()
        {
            try
            {
                DataTable table = new DataTable();
                int totalItemCount = 0;
                PagedDataTable<WareHouseMaster> lst = new PagedDataTable<WareHouseMaster>();
                try
                {
                    using (DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "Usp_GetAll_WarehouseMaster"))

                    {
                        ...
                        lst = table.ToPagedDataTableList<WareHouseMaster>
                           (1, 20, totalItemCount, null, "WareHouseName", "ASC");
                    }
                }
                catch
                {
