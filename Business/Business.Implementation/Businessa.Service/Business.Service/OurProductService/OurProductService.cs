...
namespace Business.Service.OurProductService
{
    public class OurProductService : IOurProductService
    {
        ...
        public async Task<int> IGoForRFQCardItem(GoForRFQCard goForRFQCard, DataTable dataTable)
        {
            try
            {
                SqlParameter[] param = {
