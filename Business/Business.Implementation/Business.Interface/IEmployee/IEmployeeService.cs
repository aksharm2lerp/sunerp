...
namespace Business.Interface.IEmployee
{
    public interface IEmployeeService
    {
        ...
        Task<DataTable> GetEmployeeSalaryBreakup(int employeeId);
        Task<int> AddUpdateEmployeeSalaryBreakup(DataTable dataTable);
       ...
       Task<int> AddUpdateEmployeeMedicalInsurance(EmployeeMedicalInsurance employeeMedicalInsurance);
        ...
        Task<PagedDataTable<EmployeeMaster>> GetAllEmployeesForDropDown(int? userid, int? companyid);

        #endregion Employee Salary Paid Hours

        Task<EmployeeDetails> GetEmployeeAsync2(int employeeId);
        Task<UserEmpDetail> GetLoginUserDetailAsync(int UserID);

        #region Employment Status change by Hr

        Task<EmploymentStatusChangeHr> EmploymentStatusChangeHr(int employeeId);

        Task<int> AddUpdateEmploymentStatusChangeHr(EmploymentStatusChangeHr employmentStatusChangeHr);

        #endregion Employment Status change by Hr

        #region Employment Type change by Hr

        Task<EmploymentTypeChangeHr> EmploymentTypeChangeHr(int employeeId);

        Task<int> AddUpdateEmploymentTypeChangeHr(EmploymentTypeChangeHr employmentTypeChangeHr);
        Task<EmployeePromotionIncrement> GetEmployeePromotionIncrementAsync(int employeeId);
        Task<int> AddUpdateEmployeePromotionIncrementAsync(EmployeePromotionIncrement employeePromotionIncrement);

        #endregion Employment Type change by Hr
    }
}