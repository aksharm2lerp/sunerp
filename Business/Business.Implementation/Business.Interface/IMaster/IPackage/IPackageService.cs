...
namespace Business.Interface.Marketing.IPackage
{
    public interface IPackageService
    {
        ...
        Task<PagedDataTable<PackageFormTxn>> GetAllPackageForDropDownList();
        Task<int> AddUpdateFormAssignToPackage(DataTable dataTable);
        Task<PagedDataTable<IconMaster>> GetAllIconNameForDropDownList();
