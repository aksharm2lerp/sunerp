...
namespace Business.Interface.ISalaryFormula
{
    public interface ISalaryFormula
    {
        ...
        Task<PagedDataTable<SalaryFormula>> GetAllSalaryFormula(int employeeCategoryId,int salaryFormulaTypeId, int pageNo = 1, int pageSize = 10, string searchString = "", string orderBy = "SrNo", string sortBy = "ASC");
