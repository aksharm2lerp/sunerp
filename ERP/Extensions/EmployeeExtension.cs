...
namespace ERP.Extensions
{
    public class EmployeeExtension
    {
        ...
        */
        ...
        #region Employee Salary BreakUp
        public static System.Data.DataTable GetEmployeeSalaryBreakup(int employeeId)
        {
            try
            {
                var employeeSalary = _employeeService.GetEmployeeSalaryBreakup(employeeId).Result;
        ...
        #region Employee Dropdown List

        public static SelectList GetAllEmployeesForDropDown(int? userid, int? companyid)
        {
            try
            {
                var employeeList = _employeeService.GetAllEmployeesForDropDown(userid, companyid).Result;
        ...
        #endregion Employee Dropdown List

        #region Employee Promotion & Increment
        public static EmployeePromotionIncrement GetEmployeePromotionIncrement(int employeeId)
        {
            try
            {
                EmployeePromotionIncrement employeePromotionIncrement = new EmployeePromotionIncrement();
                List<EmployeePromotionIncrement> employeePromotionIncrements = new List<EmployeePromotionIncrement>();
                employeePromotionIncrement.EmployeeID = employeeId;
                var promotionIncrement = _employeeService.GetEmployeePromotionIncrementAsync(employeeId).Result;

                if (promotionIncrement != null)
                {
                    employeePromotionIncrement = promotionIncrement;
                    if (employeePromotionIncrement.employeePromotionIncrements == null)
                        employeePromotionIncrement.employeePromotionIncrements = employeePromotionIncrements;
                }
                else
                    employeePromotionIncrement.employeePromotionIncrements = employeePromotionIncrements;
                return employeePromotionIncrement;
            }
            catch
            {
                return null;
