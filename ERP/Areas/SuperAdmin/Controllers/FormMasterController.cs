    ...
    public class FormMasterController : SettingsController
    {
        ...
        public PartialViewResult Get(int id, string key)
        {
            try
            {
                ...
                var ParentMenuList = _masterService.GetAllParentMenuListAsync();
                ViewData["ParentMenuName"] = new SelectList(ParentMenuList, "ParentMenuID", "ParentMenuName");

                var MenuList = _masterService.GetAllMenuListAsync();
                ViewData["MenuName"] = new SelectList(MenuList, "MenuID", "MenuName");
