...
namespace ERP.Areas.HR.Controllers
{
    ...
    public class SalaryFormulaController : SettingsController
    {
        ...
        public ActionResult GetAllSalaryFormula([FromQuery(Name = "grid-page")] string gridpage = "1", [FromQuery(Name = "grid-column")] string orderby = "", [FromQuery(Name = "grid-dir")] string sortby = "0", [FromQuery(Name = "grid-filter")] string gridfilter = "", [FromQuery(Name = "grid-search")] string search = "")
        {
            ...
            PagedDataTable<SalaryFormula> pds = _salaryFormula.GetAllSalaryFormula(0,0, gridpage.ToInt(), PAGESIZE, search, orderby.RemoveSpace(), sortby == "0" ? "ASC" : "DESC").Result;
        ...
        [HttpGet]
        public ActionResult GetSalaryFormulaByEmployeeCategoryId(int employeeCategoryId, int salaryFormulaTypeId, [FromQuery(Name = "grid-page")] string gridpage = "1", [FromQuery(Name = "grid-column")] string orderby = "", [FromQuery(Name = "grid-dir")] string sortby = "0", [FromQuery(Name = "grid-filter")] string gridfilter = "", [FromQuery(Name = "grid-search")] string search = "")
        {
            try
            {
                /* string gridpage = "1";
                ...
                PagedDataTable<SalaryFormula> pds = _salaryFormula.GetAllSalaryFormula(employeeCategoryId, salaryFormulaTypeId, gridpage.ToInt(), PAGESIZE, search, orderby.RemoveSpace(), sortby == "0" ? "ASC" : "DESC").Result;
                ...
                ViewData["SalaryFormulaTypeID"] = salaryFormulaTypeId;
